        ...
        <ul className="listado">
            {
                ...
                continentes.map((continente)=>{
                    if(mostrarActivos===true){ 
                        return <Continente key={continente.id} continente={continente} cambiarEstatus={cambiarEstatus} editarContinente={editarContinente} eliminarContinente={eliminarContinente}/>
                ...
                :
                <div className="listado_mensaje">No Hay Continentes Agregados</div>
            }
        </ul>
    );
}
